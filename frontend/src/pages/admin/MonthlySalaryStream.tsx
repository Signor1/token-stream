...
const MonthlySalaryStream = () => {
    return (
        <main className="w-full h-full flex flex-col gap-4 mt-10 ml-2 pr-2">
            <div className="w-full flex flex-col gap-2">
                <h1 className="md:text-4xl text-2xl text-gray-300 font-belanosima">List of Monthly Salary Streams</h1>
...
export default MonthlySalaryStream
